            ...
            <div className="row row-content">
                <div className="col">
                    <p id="bio">
                        ...
                        Before I ever read a line of code, I spent a lot of time working with the public.  From retail management to hospitality service I have needed to be an effective communicator and problem solver.  Prioritization and adaptation have been key components to this portion of my career as well.
